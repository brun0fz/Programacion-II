...
nodo *buscarNodo(nodo **pLista, char nombre[])
{
    ...
    while((seg !=NULL) && (strcmp(nombre, seg->dato.nombreApe) !=0))
    {
        seg=seg->siguiente;
    }
...
void borrarNodo(nodo **pLista, char nombre[])
{
    ...
    if(*pLista!=NULL)
    {
        ...
        if((strcmp(nombre, (*pLista)->dato.nombreApe)==0))
        {
...
void agregarEnOrden(nodo **pLista, nodo *nuevoNodo)
{
    ...
    else
    {
        ...
        if(nuevoNodo->dato.nota < (*pLista)->dato.nota)
        {
